from context_enrichment.context_chunk_header import ContextChunkHeaderRAGRetriever
from context_enrichment.context_enrichment_window import ContextEnrichmentRAG
from context_enrichment.contextual_compression import ContextualCompressionRAG
from context_enrichment.document_augmentation import DocumentAugmentationRAG
from context_enrichment.semantic_chunking_rag import SemanticChunkingRAG
from context_enrichment.relevant_segment_extraction_openai import RSERetrievalRAG


from Querys.HyDE_RAG import HyDERAGRetriever
from Querys.HyPE_RAG import HyPERAGRetriever
from Querys.query_transform import QueryTransformRagOpenai

from reliable_rag.reliable_rag_openai import ReliableRAGOpenAI

from simple_rag.propositions_chunking_rag import PropositionChunkRagOpenai
from simple_rag.simple_rag_openai import SimpleRAGOpenai


from advanced_retrieval.dartboard_rag import DartboardRAG
from advanced_retrieval.fusion_retrieval import FusionRetrievalRAG
from advanced_retrieval.hierarchy_indices import HierarchicalIndicesRAG
from advanced_retrieval.reranking_rag import RerankingRAG

from Explainbility.explainable_retrieval_rag import ExplainableRetrievalRAG


from Iterative_Techniques.adaptive_retrieval_rag import AdaptiveRetrievalRAG
# from Iterative_Techniques.feedback_loop_rag import FeedbackLoopRAG
...
class evaluate_rag_techniques:
    def __init__(self, file_path:str, question_file_path:str, metric_list:list[str]):
        ...
        self.rag_techniques = {
            "context_chunk_rag" : ContextChunkHeaderRAGRetriever,
            "hyde_rag" : HyDERAGRetriever,
            "hyper_rag" : HyPERAGRetriever,
            "query_transform_rag" : QueryTransformRagOpenai,
            "reliable_rag" : ReliableRAGOpenAI,
            "proposition_chunk_rag" : PropositionChunkRagOpenai,
            "simple_rag" : SimpleRAGOpenai,
            "adaptive_retrieval_rag" : AdaptiveRetrievalRAG,
            "explainable_retrieval_rag" : ExplainableRetrievalRAG,
            "context_enrichment_rag" : ContextEnrichmentRAG,
            "contextual_compression_rag" : ContextualCompressionRAG,
            "document_augmentation_rag" : DocumentAugmentationRAG,
            "semantic_chunking_rag" : SemanticChunkingRAG,
            "rsr_rag" : RSERetrievalRAG,
            "dartboard_rag" : DartboardRAG,
            "fusion_retrieval_rag" : FusionRetrievalRAG,
            "hierarchical_indices_rag" : HierarchicalIndicesRAG,
...
if __name__ == "__main__":
    ...
    demo_evaluate_rag_techniques = evaluate_rag_techniques(file_path=r"data\IntermediaryGuidelinesandDigitalMediaEthicsCode.pdf", question_file_path=r"data\gold_standared_q_a.json", metric_list=["correctness", "faithfulness", "completeness", "relevancy"])

    jsonfile_output_path = "17_rag_techniques_output.json"
    pdf_output_path = "17_rag_techniques_output.pdf"
